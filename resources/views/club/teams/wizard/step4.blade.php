...
@section('title', 'Build Formation - Step 4')
@section('page_title', 'Build Formation - Step 4')
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h4 class="card-title">Step 4 of 4: Arrange Formation for {{ $team->name }}</h4>
                </div>
                <div class="card-body">
                    @if ($team->players->isEmpty())
                        <div class="alert alert-warning mb-4">
                            You have not selected any players yet. Return to Step 3 to add players to this team.
                        </div>
                    @endif

                    @if ($positions->isEmpty())
                        <div class="alert alert-info mb-4">
                            No positions exist for {{ $team->sport->name ?? 'this sport' }}. Players can remain in the Reserves zone.
                        </div>
                    @endif

                    <form method="POST" action="{{ route('club.teams.wizard.finalizeFormation', $team) }}" id="formationForm">
                        @csrf

                        <div class="row">
                            <div class="col-lg-4">
                                <h5>Reserves / Unassigned</h5>
                                <div id="playerPool" class="drop-zone {{ $benchPlayers->isEmpty() ? 'empty' : '' }}" data-position="" data-placeholder="Drop players here to keep them unassigned">
