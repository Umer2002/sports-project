...
<style>
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h2>All Events</h2>
            <a href="{{ route('club.events.create') }}" class="btn btn-primary theme-btn">Create New Event</a>
        </div>
            ...
            <tbody>
                @foreach ($events as $event)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('club.events.edit', $event->id) }}" class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{ route('club.events.destroy', $event->id) }}" method="POST"
