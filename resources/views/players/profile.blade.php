<x-spike-layouts>
    <div class="mb-3 overflow-hidden position-relative">
        <div class="px-3">
            <h4 class="fs-6 mb-0">Users Profile</h4>
    ...
    <div class="card overflow-hidden">
        <div class="card-body p-0">
            <img src="{{ asset('spike/assets/images/backgrounds/profilebg.jpg' ) }}" alt="spike-img" class="img-fluid">
...
<div class="rounded-circle position-relative mb-9 mb-md-0 d-inline-block">
                      <img src="{{ asset('spike/assets/images/profile/user-1.jpg' ) }}" alt="spike-img" class="img-fluid rounded-circle" width="100" height="100">
                      <span class="text-bg-primary rounded-circle text-white d-flex align-items-center justify-content-center position-absolute bottom-0 end-0 p-1 border border-2 border-white">
                        <i class="ti ti-plus" data-bs-toggle="modal" data-bs-target="#player-image-modal"></i>
                      </span>
                    </div>
                            </div>
                        </div>
            ...
            <ul class="nav nav-pills user-profile-tab justify-content-end mt-2 bg-primary-subtle rounded-2 rounded-top-0"
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link hstack gap-2 rounded-0 py-6" id="pills-followers-tab" data-bs-toggle="pill"
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link hstack gap-2 rounded-0 py-6" id="pills-friends-tab" data-bs-toggle="pill"
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link hstack gap-2 rounded-0 py-6" id="pills-gallery-tab" data-bs-toggle="pill"
                ...
                <div class="col-lg-4">
                    <div class="card shadow-none border">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle">Hello, I am Mike Nielsen. I love making websites and graphics.
                                Lorem
                            ...
                            <div class="vstack gap-3 mt-4">
                                ...
                                <div class="hstack gap-6">
                                    ...
                                    <h6 class=" mb-0">xyzmikenielsen@gmail.com</h6>
                                </div>
                                <div class="hstack gap-6">
                    ...
                    <div class="card shadow-none border">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <img src="{{ asset('spike/assets/images/profile/user-1.jpg' ) }}" alt="spike-img"
                                        class="rounded-1 img-fluid mb-9">
                                </div>
                                <div class="col-4">
                                    <img src="{{ asset('spike/assets/images/profile/user-2.jpg' ) }}" alt="spike-img"
                                        class="rounded-1 img-fluid mb-9">
                                </div>
                                <div class="col-4">
                                    <img src="{{ asset('spike/assets/images/profile/user-3.jpg' ) }}" alt="spike-img"
                                        class="rounded-1 img-fluid mb-9">
                                </div>
                                <div class="col-4">
                                    <img src="{{ asset('spike/assets/images/profile/user-4.jpg' ) }}" alt="spike-img"
                                        class="rounded-1 img-fluid mb-9">
                                </div>
                                <div class="col-4">
                                    <img src="{{ asset('spike/assets/images/profile/user-5.jpg' ) }}" alt="spike-img"
                                        class="rounded-1 img-fluid mb-9">
                                </div>
                                <div class="col-4">
                                    <img src="{{ asset('spike/assets/images/profile/user-6.jpg' ) }}" alt="spike-img"
                                        class="rounded-1 img-fluid mb-9">
                                </div>
                                <div class="col-4">
                                    <img src="{{ asset('spike/assets/images/profile/user-7.jpg' ) }}" alt="spike-img"
                                        class="rounded-1 img-fluid mb-6">
                                </div>
                                <div class="col-4">
                                    <img src="{{ asset('spike/assets/images/profile/user-8.jpg' ) }}" alt="spike-img"
                                        class="rounded-1 img-fluid mb-6">
                                </div>
                                <div class="col-4">
                                    <img src="{{ asset('spike/assets/images/profile/user-1.jpg' ) }}" alt="spike-img"
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body border-bottom">
                            <div class="d-flex align-items-center gap-6 flex-wrap">
                                <img src="{{ asset('spike/assets/images/profile/user-1.jpg' ) }}" alt="spike-img" class="rounded-circle"
                                    width="40" height="40">
                                <h6 class="mb-0">Mike Nielsen</h6>
                            ...
                            <p class="text-dark my-3">
                                Nu kek vuzkibsu mooruno ejepogojo uzjon gag fa ezik disan he nah. Wij wo pevhij tumbug
                                rohsa
                                ahpi ujisapse lo vap labkez eddu suk.
                            </p>
                            <img src="{{ asset('spike/assets/images/products/s1.jpg' ) }}" alt="spike-img" height="360"
                            ...
                            <div class="position-relative">
                                <div class="p-4 rounded-4 text-bg-light mb-3">
                                    <div class="d-flex align-items-center gap-6 flex-wrap">
                                        ...
                                        <span class="fs-2">
                                            <span class="p-1 text-bg-muted rounded-circle d-inline-block"></span> 8 min
                                            ago
                                        </span>
                                    </div>
                                    <p class="my-3">Lufo zizrap iwofapsuk pusar luc jodawbac zi op uvezojroj duwage
                                        vuhzoc ja
                                        vawdud le furhez siva
                                        fikavu ineloh. Zot afokoge si mucuve hoikpaf adzuk zileuda falohfek zoije fuka
                                        udune lub
                                        annajor gazo
                                        conis sufur gu.
                                    </p>
                                ...
                                <div class="p-4 rounded-2 text-bg-light ms-7">
                                    ...
                                    <p class="my-3">
                                        Olte ni somvukab ugura ovaobeco hakgoc miha peztajo tawosu udbacas kismakin hi.
                                        Dej
                    ...
                    <div class="card">
                        <div class="card-body border-bottom">
                            <div class="d-flex align-items-center gap-6 flex-wrap">
                                <img src="{{ asset('spike/assets/images/profile/user-5.jpg' ) }}" alt="spike-img" class="rounded-circle"
                                    width="40" height="40">
                                <h6 class="mb-0">Carry Minati</h6>
                                <span class="fs-2">
                            ...
                            <p class="text-dark my-3">
                                Pucnus taw set babu lasufot lawdebuw nem ig bopnub notavfe pe ranlu dijsan liwfekaj lo
                                az. Dom
                                giat gu
                    ...
                    <div class="card">
                        <div class="card-body border-bottom">
                            <div class="d-flex align-items-center gap-6 flex-wrap">
                                <img src="{{ asset('spike/assets/images/profile/user-2.jpg' ) }}" alt="spike-img" class="rounded-circle"
                                    width="40" height="40">
                            ...
                            <p class="text-dark my-3">
                                Faco kiswuoti mucurvi juokomo fobgi aze huweik zazjofefa kuujer talmoc li niczot lohejbo
                                vozev
                                zi huto. Ju
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <img src="{{ asset('spike/assets/images/products/s2.jpg' ) }}" alt="spike-img"
                                        class="img-fluid rounded-4 mb-3 mb-sm-0">
                                </div>
                                <div class="col-sm-6">
                                    <img src="{{ asset('spike/assets/images/products/s4.jpg' ) }}" alt="spike-img"
        ...
        <div class="tab-pane fade" id="pills-followers" role="tabpanel" aria-labelledby="pills-followers-tab"
            ...
            <div class="d-sm-flex align-items-center justify-content-between mt-3 mb-4">
                <h3 class="mb-3 mb-sm-0 fw-semibold d-flex align-items-center">Followers <span
                        class="badge text-bg-secondary fs-2 rounded-4 py-1 px-2 ms-2">{{ $player->user->followers->count() }}</span>
                </h3>
            ...
            <div class="row">
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                            <img src="{{ asset('spike/assets/images/profile/user-3.jpg' ) }}" alt="spike-img" class="rounded-circle"
                                width="40" height="40">
                            <div>
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                            <img src="{{ asset('spike/assets/images/profile/user-4.jpg' ) }}" alt="spike-img" class="rounded-circle"
                                width="40" height="40">
                            <div>
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                            <img src="{{ asset('spike/assets/images/profile/user-6.jpg' ) }}" alt="spike-img" class="rounded-circle"
                                width="40" height="40">
                            <div>
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                            <img src="{{ asset('spike/assets/images/profile/user-7.jpg' ) }}" alt="spike-img" class="rounded-circle"
                                width="40" height="40">
                            <div>
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                            <img src="{{ asset('spike/assets/images/profile/user-8.jpg' ) }}" alt="spike-img" class="rounded-circle"
                                width="40" height="40">
                            <div>
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                            <img src="{{ asset('spike/assets/images/profile/user-9.jpg' ) }}" alt="spike-img" class="rounded-circle"
                                width="40" height="40">
                            <div>
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                            <img src="{{ asset('spike/assets/images/profile/user-10.jpg' ) }}" alt="spike-img" class="rounded-circle"
                                width="40" height="40">
                            <div>
        ...
        <div class="tab-pane fade" id="pills-friends" role="tabpanel" aria-labelledby="pills-friends-tab" tabindex="0">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4">
                    <div class="card hover-img">
                        <div class="card-body p-4 text-center border-bottom">
                            <img src="{{ asset('spike/assets/images/profile/user-1.jpg' ) }}" alt="spike-img" class="rounded-circle mb-3"
                                width="80" height="80">
                            <h5 class="fw-semibold mb-0">Betty Adams</h5>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card hover-img">
                        <div class="card-body p-4 text-center border-bottom">
                            <img src="{{ asset('spike/assets/images/profile/user-2.jpg' ) }}" alt="spike-img" class="rounded-circle mb-3"
                                width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card hover-img">
                        <div class="card-body p-4 text-center border-bottom">
                            <img src="{{ asset('spike/assets/images/profile/user-3.jpg' ) }}" alt="spike-img" class="rounded-circle mb-3"
                                width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card hover-img">
                        <div class="card-body p-4 text-center border-bottom">
                            <img src="{{ asset('spike/assets/images/profile/user-4.jpg' ) }}" alt="spike-img" class="rounded-circle mb-3"
                                width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card hover-img">
                        <div class="card-body p-4 text-center border-bottom">
                            <img src="{{ asset('spike/assets/images/profile/user-5.jpg' ) }}" alt="spike-img" class="rounded-circle mb-3"
                                width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card hover-img">
                        <div class="card-body p-4 text-center border-bottom">
                            <img src="{{ asset('spike/assets/images/profile/user-6.jpg' ) }}" alt="spike-img" class="rounded-circle mb-3"
                                width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card hover-img">
                        <div class="card-body p-4 text-center border-bottom">
                            <img src="{{ asset('spike/assets/images/profile/user-7.jpg' ) }}" alt="spike-img" class="rounded-circle mb-3"
                                width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card hover-img">
                        <div class="card-body p-4 text-center border-bottom">
                            <img src="{{ asset('spike/assets/images/profile/user-8.jpg' ) }}" alt="spike-img" class="rounded-circle mb-3"
                                width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card hover-img">
                        <div class="card-body p-4 text-center border-bottom">
                            <img src="{{ asset('spike/assets/images/profile/user-9.jpg' ) }}" alt="spike-img" class="rounded-circle mb-3"
                                width="80" height="80">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card hover-img">
                        <div class="card-body p-4 text-center border-bottom">
                            <img src="{{ asset('spike/assets/images/profile/user-10.jpg' ) }}" alt="spike-img" class="rounded-circle mb-3"
                                width="80" height="80">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="card hover-img overflow-hidden">
                        <div class="card-body p-0">
                            <img src="{{ asset('spike/assets/images/products/s1.jpg' ) }}" alt="spike-img" height="220"
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card hover-img overflow-hidden">
                        <div class="card-body p-0">
                            <img src="{{ asset('spike/assets/images/products/s2.jpg' ) }}" alt="spike-img" height="220"
                                class="w-100 object-fit-cover">
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card hover-img overflow-hidden">
                        <div class="card-body p-0">
                            <img src="{{ asset('spike/assets/images/products/s3.jpg' ) }}" alt="spike-img" height="220"
                                class="w-100 object-fit-cover">
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card hover-img overflow-hidden">
                        <div class="card-body p-0">
                            <img src="{{ asset('spike/assets/images/products/s4.jpg' ) }}" alt="spike-img" height="220"
                                class="w-100 object-fit-cover">
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card hover-img overflow-hidden">
                        <div class="card-body p-0">
                            <img src="{{ asset('spike/assets/images/products/s5.jpg' ) }}" alt="spike-img" height="220"
                                class="w-100 object-fit-cover">
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card hover-img overflow-hidden">
                        <div class="card-body p-0">
                            <img src="{{ asset('spike/assets/images/products/s6.jpg' ) }}" alt="spike-img" height="220"
                                class="w-100 object-fit-cover">
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card hover-img overflow-hidden">
                        <div class="card-body p-0">
                            <img src="{{ asset('spike/assets/images/products/s7.jpg' ) }}" alt="spike-img" height="220"
                                class="w-100 object-fit-cover">
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card hover-img overflow-hidden">
                        <div class="card-body p-0">
                            <img src="{{ asset('spike/assets/images/products/s8.jpg' ) }}" alt="spike-img" height="220"
                                class="w-100 object-fit-cover">
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card hover-img overflow-hidden">
                        <div class="card-body p-0">
                            <img src="{{ asset('spike/assets/images/products/s9.jpg' ) }}" alt="spike-img" height="220"
                                class="w-100 object-fit-cover">
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card hover-img overflow-hidden">
                        <div class="card-body p-0">
                            <img src="{{ asset('spike/assets/images/products/s10.jpg' ) }}" alt="spike-img" height="220"
                                class="w-100 object-fit-cover">
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card hover-img overflow-hidden">
                        <div class="card-body p-0">
                            <img src="{{ asset('spike/assets/images/products/s11.jpg' ) }}" alt="spike-img" height="220"
                                class="w-100 object-fit-cover">
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                <div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card hover-img overflow-hidden">
                        <div class="card-body p-0">
                            <img src="{{ asset('spike/assets/images/products/s12.jpg' ) }}" alt="spike-img" height="220"
                                class="w-100 object-fit-cover">
                            <div class="p-4 d-flex align-items-center justify-content-between">
                                <div>
...
<div id="player-image-modal" class="modal fade" tabindex="-1" aria-modal="true" role="dialog">
                          ...
                          <div class="modal-body">
                            <div class="text-center mt-2 mb-4">
                              <a href="#" class="text-success">
                                <span>
                                  <img src="{{/spike/assets/images/logos/favicon.png" class="me-3 img-fluid" alt="spike-img">
                                </span>
                              </a>
                            </div>
