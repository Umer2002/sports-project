...
@section('content')
    <div class="container">
        <div class="register-box">
            <h3 class="text-center text-heading mb-4">Ambassador Registration</h3>
            ...
            <form method="POST" action="{{ route('register.ambassador.store') }}">
                @csrf
                <input type="hidden" name="user_type" value="ambassador">
                ...
                <div class="mb-3">
                    <label class="form-label">Sport Focus</label>
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" id="ambassadorTerms" required>
                    <label class="form-check-label" for="ambassadorTerms">
                        By signing up you agree to our Terms of Services and Privacy Policy.
                    </label>
                </div>

                <div class="text-center">
                    <button type="submit" class="btn btn-signup w-100">Join as Ambassador</button>
                </div>
