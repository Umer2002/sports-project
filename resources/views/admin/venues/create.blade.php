    ...
    <form action="{{ route('admin.venues.store') }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <select name="state_id" id="venue-state" class="form-select @error('state_id') is-invalid @enderror" required disabled>
            ...
            <div class="col-md-4">
                ...
                <select name="city_id" id="venue-city" class="form-select @error('city_id') is-invalid @enderror" required disabled>
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="capacity" value="{{ old('capacity') }}" class="form-control @error('capacity') is-invalid @enderror" min="0">
                @error('capacity')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-6">
                <label class="form-label">Location (override)</label>
                <input type="text" name="location" id="venue-location" value="{{ old('location') }}" class="form-control @error('location') is-invalid @enderror" placeholder="Search or keep default location">
...
<script>
    (function ($) {
        ...
        const initialCountryId = @json(old('country_id'));
        const initialStateId = @json(old('state_id'));
