...
<div class=" _invite-card text-white mb-4 rounded-4 card">
    <div class="body">
        ...
        <!-- ROW 1 ▸ Invite friends / Earn 10$  + logo -->
        <div class="d-flex">
            <!-- Step number -->
            ...
            <div class="flex-grow-1">
                <div class="d-flex flex-wrap align-items-center">
                    <span class="me-2 vsmall text-uppercase fw-semibold">Invite friends</span>
                    <span class="text-success fw-bold text-uppercase ms-auto me-2">Earn</span>
                    <span class="display-6 fw-bold mb-0 cblue">10 $</span>
                </div>
            </div>
        ...
        <div class="d-flex">
            ...
            <p class="mb-0 flex-grow-1 vsmall">
                For every friend that registers to <strong>Play 2 Earn Sports</strong> you will receive <strong>10 $
                    USD</strong>
            </p>
